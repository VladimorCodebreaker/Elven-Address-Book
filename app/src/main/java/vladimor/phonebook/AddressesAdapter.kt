...
import vladimor.phonebook.databinding.AddressItemBinding

const val ADDRESS_ID_MESSAGE = "vladimor.phonebook@ADDRESS_ID_MESSAGE"

class AddressesAdapter : ListAdapter<Address, AddressesAdapter.AddressItemViewHolder>(DiffCallback),
    PopupTextProvider {
    companion object {
